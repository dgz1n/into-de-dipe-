...
public final class TwoDeadWheelLocalizer implements Localizer {
    public static class Params {
        public double parYTicks = 1861.6098167738355; // y position of the parallel encoder (in tick units)
        public double perpXTicks = 1834.1711852437165; // x position of the perpendicular encoder (in tick units)
    }
